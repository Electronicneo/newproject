...
function UserEnablingComponent_ng_template_2_ng_template_9_Template(rf, ctx) { if (rf & 1) {
    ...
    i0.ɵɵlistener("checkedChange", function UserEnablingComponent_ng_template_2_ng_template_9_Template_nb_toggle_checkedChange_0_listener() { i0.ɵɵrestoreView(_r13); var rowData_r4 = i0.ɵɵnextContext().$implicit; var ctx_r11 = i0.ɵɵnextContext(); return ctx_r11.checkedChange(rowData_r4); })("checkedChange", function UserEnablingComponent_ng_template_2_ng_template_9_Template_nb_toggle_checkedChange_0_listener($event) { i0.ɵɵrestoreView(_r13); var rowData_r4 = i0.ɵɵnextContext().$implicit; return rowData_r4.enabling.defaultEnabling = $event; });
    i0.ɵɵelementEnd();
} if (rf & 2) {
    var rowData_r4 = i0.ɵɵnextContext().$implicit;
...
function UserEnablingComponent_button_5_Template(rf, ctx) { if (rf & 1) {
    ...
    i0.ɵɵlistener("click", function UserEnablingComponent_button_5_Template_button_click_0_listener() { i0.ɵɵrestoreView(_r18); var ctx_r17 = i0.ɵɵnextContext(); return ctx_r17.enablingManagerSave(ctx_r17.userEnablingSelected); });
...
function UserEnablingComponent_button_7_Template(rf, ctx) { if (rf & 1) {
    ...
    i0.ɵɵelementStart(0, "button", 16);
    i0.ɵɵlistener("click", function UserEnablingComponent_button_7_Template_button_click_0_listener($event) { i0.ɵɵrestoreView(_r20); var ctx_r19 = i0.ɵɵnextContext(); return ctx_r19.enablingManagerCancel($event); });
    i0.ɵɵelementStart(1, "span", 7);
    i0.ɵɵtext(2, "crudForm.enablingManager.buttonCancel");
    i0.ɵɵelementEnd();
    i0.ɵɵelementEnd();
} }
var UserEnablingComponent = /** @class */ (function () {
    function UserEnablingComponent() {
    ...
    UserEnablingComponent.prototype.ngOnInit = function () {
    };
    UserEnablingComponent.prototype.enablingManagerSave = function (event) {
        this.enablingManagerSaveEmitter.emit(event);
    };
    UserEnablingComponent.prototype.enablingManagerCancel = function (event) {
        this.enablingManagerCancelEmitter.emit(event);
    };
    UserEnablingComponent.prototype.enablingManagerSelect = function (event) {
        this.enablingManagerSelectEmitter.emit(event);
    };
    UserEnablingComponent.prototype.checkedChange = function (userEnablingChecked) {
        this.userEnablingSelected = userEnablingChecked;
        this.userEnablingList.forEach(function (userEnabling) {
    ...
    return UserEnablingComponent;
}());
export { UserEnablingComponent };
