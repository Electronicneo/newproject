...
export class CustomersComponent implements OnInit, OnDestroy {
  ...
  constructor(public customersFacade: CustomersFacadeService,
    ...
    public cardservice: CardViewService) { }
  ...
  // NOTE for that you could use only one flag
  public viewCardss() {
    this.cardservice.viewCard = true;
    this.cardservice.viewTable = false;
    this.cardservice.formCard = false;
  }
  public viewTablee() {
    this.cardservice.viewCard = false;
    this.cardservice.viewTable = true;
    this.cardservice.formCard = false;
  }
  open() {
  ...
  public setCurrentCustomers(customer: ICustomers) {
  ...
  public removeCustomerss(customer: ICustomers) {
    this.setSuccessState(false);
    this.customersFacade.removeCustomers(customer);
  }
  ...
  public helpPage($event) {
    this.dialogService.open(DialogMessageComponent, {
      context: { isConfirmationMode: false, title: this.translate.instant('customers.help.pageTitle'), message: this.translate.instant('customers.help.pageMessage') },
    })
  }

  public helpTable($event) {
    this.dialogService.open(DialogMessageComponent, {
      context: { isConfirmationMode: false, title: this.translate.instant('customers.help.tableTitle'), message: this.translate.instant('customers.help.tableMessage') },
    })
  }
}
